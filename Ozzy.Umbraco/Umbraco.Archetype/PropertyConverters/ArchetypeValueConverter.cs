...
namespace Archetype.PropertyConverters
{
    ...
    public class ArchetypeValueConverter : PropertyValueConverterBase
    {
        ...
        public override bool IsConverter(PublishedPropertyType propertyType)
        {
            ...
            return !Extensions.ArchetypeHelper.Instance.IsPropertyValueConverterOverridden(propertyType.DataTypeId);
        }
        ...
        public override object ConvertDataToSource(PublishedPropertyType propertyType, object source, bool preview)
        {
            ...
            {
                var archetype = Extensions.ArchetypeHelper.Instance.DeserializeJsonToArchetype(sourceString,
