...
/* Version 1.13.1 */
angular.module("umbraco").controller("Ozzy.Imulus.ArchetypeController", function ($scope, $http, $filter, assetsService, angularHelper, notificationsService, $timeout, fileManager, entityResource, archetypeService, archetypeLabelService, archetypeCacheService, archetypePropertyEditorResource) {

    // Variables.
    var draggedParent;
    $scope.mode2 = $scope.model;
    $scope.model = {};

    //$scope.model.value = "";
    $scope.model.hideLabel = $scope.control.editor.hideLabel == 1;

    //set the config equal to our prevalue config
    //$scope.model.config = $scope.model.config.archetypeConfig;
    $scope.model.config = $scope.control.editor.config;

    //ini the model
    $scope.model.value = JSON.parse($scope.control.value) || getDefaultModel($scope.model.config);
    ...
    //archetype css
    assetsService.loadCss("../App_Plugins/Ozzy.Grid.Archetype/style.css");
    ...
    $scope.$on("archetypeFormSubmitting", function (ev, args) {
        ...
        var value = {};
        value.fieldsets = $scope.model.value.fieldsets;
        $scope.control.value = JSON.stringify(value);
    });
...
angular.module("umbraco").controller("Ozzy.Imulus.ArchetypeConfigController", function ($scope, $http, assetsService, dialogService, archetypePropertyEditorResource) {
...
angular.module('umbraco').controller('Ozzy.ArchetypeConfigOptionsController', function ($scope) {
...
angular.module("umbraco.directives").directive('ozzyArchetypeProperty', function ($compile, $http, archetypePropertyEditorResource, umbPropEditorHelper, $timeout, $rootScope, $q, fileManager, editorState, archetypeService, archetypeCacheService) {
...
angular.module("umbraco.directives").directive('ozzyArchetypeSubmitWatcher', function ($rootScope) {
    var linker = function (scope, element, attrs, ngModelCtrl) {
...
angular.module("umbraco.directives").directive('ozzyArchetypeCustomView', function ($compile, $http) {
    var linker = function (scope, element, attrs) {

        var view = "../App_plugins/Ozzy.Grid.Archetype/ozzy.archetype.default.html";
...
angular.module("umbraco.directives").directive('ozzyArchetypeLocalize', function (archetypeLocalizationService) {
    var linker = function (scope, element, attrs) {
...
angular.module("umbraco.directives").directive('ozzyArchetypeClickOutside', function ($timeout, $parse) {
        return {
            restrict: 'A',
...
angular.module('umbraco.services').factory('ozzyArchetypeLocalizationService', function ($http, $q, userService) {
    var service = {
...
angular.module('umbraco.resources').factory('ozzyArchetypePropertyEditorResource', function ($q, $http, umbRequestHelper) {
    return {
...
angular.module('umbraco.services').factory('ozzyArchetypeService', function () {
...
angular.module('umbraco.services').factory('ozzyArchetypeLabelService', function (archetypeCacheService) {
    //private
...
angular.module('umbraco.services').factory('ozzyArchetypeCacheService', function (archetypePropertyEditorResource) {
    //private
