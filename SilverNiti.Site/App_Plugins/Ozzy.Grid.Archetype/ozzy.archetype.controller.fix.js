        ...
        $httpProvider.interceptors.push(function ($q) {
            return {
                'request': function (request) {
                    ...
                    if (request.url === "../App_Plugins/Archetype/views/archetype.html")
                        request.url = '../App_Plugins/Ozzy.Grid.Archetype/archetype.fix.html';

                    if (request.url === "../App_plugins/Archetype/views/archetype.default.html")
                        request.url = '../App_Plugins/Ozzy.Grid.Archetype/archetype.default.fix.html';
...
angular.module("umbraco").controller("Imulus.ArchetypeController2", function ($scope, $http, $filter, assetsService, angularHelper, notificationsService, $timeout, fileManager, entityResource, archetypeService, archetypeLabelService, archetypeCacheService, archetypePropertyEditorResource) {
